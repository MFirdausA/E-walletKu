...
<div class="container p-6  bg-[#f2f2f7]">
    ...
    <div class="w-full flex justify-between items-center mt-4">
        ...
        <div class="flex gap-3 items-center">
            <button id="openIncomeDetailButton" class="border border-[#ffa500] flex justify-between gap-1 py-2 px-4 my-1 mx-0.2 rounded-lg"><img class="w-6" src="{{ asset('img/calender-icon.png') }}" alt="">Filter</button>
            <a href="{{ route('income.create',['from' => 'detail']) }}" class="w-[42px] h-[42px] px-2 bg-[#ffa500] rounded-[100px] justify-center items-center gap-2.5 inline-flex">
    ...
    <div class="w-full mt-3">
        ...
        <div class="text-black text-[32px] font-bold font-['Poppins']">IDR {{ number_format($incomeAmount , 2, ',', '.') }}</div>
    </div>
    ...
    <section>
        ...
        <a href="{{route('pages.transaction-detail', ['id' => $transaction->id, 'type' => 'Income', 'from' => 'detail-income'])}}">
    ...
    <div id="FilterModal" class="hidden fixed inset-0 z-50 justify-center items-center">
        <div class="w-full max-w-[640px] shadow-lg">
            <div class="fixed bg-white max-w-[640px] bottom-0 rounded-t-xl px-5 w-full left-[50%] translate-x-[-50%] gap-4 py-4 flex-row items-center justify-center">
                ...
                <div class="flex-col">
                    <form id="filterForm" action="{{ route('income.show') }}" method="GET">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const filterButton = document.getElementById('openIncomeDetailButton');
