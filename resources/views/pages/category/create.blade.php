    ...
    <div class="flex flex-col justify-center items-start">
        <div class=" grid-flow-col auto-cols-4">
            ...
            <div class="grid-flow-col auto-cols-4">
                ...
                <button data-modal-target="editWalletModal{{ $category->id }}" data-modal-toggle="editWalletModal{{ $category->id }}" type="button" class="border border-[#ffa500] py-2 px-4 my-1 mx-0.2 rounded-lg">
                    <div class="flex items-center gap-1">
                        <img src="{{ asset('storage/'.$category->cover) }}" class="w-6" alt="img"><span>{{ $category->name }}</span>
                    </div>
                </button>
