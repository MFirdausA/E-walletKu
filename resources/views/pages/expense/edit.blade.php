...
<div class="container p-6 min-h-screen bg-white">
    ...
    <div class="font-bold flex justify-center items-center text-xl">Update Expense</div>
    ...
    <div class=" w-full flex flex-col bg-white mt-6">
        <form action="{{ route('expense.update', ['id'=> $id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mt-3">
                ...
                <select id="wallet_id" name="wallet_id" type="select" data-selected="{{ old('wallet_id', $transaction->wallet_id ?? '') }}" class="mt-1 block w-full border-gray-300 text-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"  autofocus autocomplete="Payment Method" >
